...
CMD_HELP.update(
    {
        "anime": ">`.anilist` <anime title>"
        "\nUsage: Get anime information from anilist."
        "\n\n>`.anime` <anime title>"
        "\nUsage: Returns with anime information from MyAnimeList."
        "\n\n>`.manga` <manga title>"
        "\nUsage: Returns with manga information from MyAnimeList."
        "\n\n>`.akaizoku` or `.akayo` <anime title>"
        "\nUsage: Returns with the anime download link."
        "\n\n>`.char` <character name>"
        "\nUsage: Returns with character information."
        "\n\n>`.upcoming`"
        "\nUsage: Returns with upcoming anime information."
        "\n\n>`.whatanime` <reply to a media>"
